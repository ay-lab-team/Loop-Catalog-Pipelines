...
#PBS -o results/peaks/merged_chipline_t2t/logs/
#PBS -e results/peaks/merged_chipline_t2t/logs/
#PBS -N run_merge_chipline_t2t
#PBS -m ae
#PBS -j oe
#PBS -V

# Usage:
# qsub workflow/scripts/chipseq/run_merge_chipline_t2t.sh -F "<row 1 of ChIP-seq tracker> <row 2 of ChIP-seq tracker> <...>"
...
PATH=/mnt/bioadhoc-temp/Groups/vd-ay/nrao/hichip_database/software/sambamba:$PATH # sambamba
...
mkdir -p "results/peaks/merged_chipline_t2t/$outputfoldername"
outputfolder=$( realpath "results/peaks/merged_chipline_t2t/$outputfoldername" )

# create the portion of the command that takes the samples to merge
inputfilecommand=""
for sample in ${samples_to_merge[@]}; do
    inputfile="results/peaks/chipline_t2t/$sample/MACS2_Ext"*"/$sample.macs2_peaks.narrowPeak_Q0.01filt"
...
ChIPLineDir=/mnt/bioadhoc-temp/Groups/vd-ay/nrao/hichip_database/software/ChIPLine
...
IDRCodePackage=/mnt/bioadhoc-temp/Groups/vd-ay/nrao/hichip_database/software/IDRCode/idrCode
...
# print end message
echo "Ended: run_merge_chipline_t2t"
