...
fastq_dir="${LOOP_CATALOG_DIR}/results/fastqs/raw/revisions/${sample_name}"
final_dir="${LOOP_CATALOG_DIR}/results/revisions/juicer/work/${sample_name}"
...
then
    ...
    site_option="${LOOP_CATALOG_DIR}/results/revisions/juicer/restriction_sites/${genome}_${re}.txt"
