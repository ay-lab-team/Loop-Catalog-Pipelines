...
#for fn in $(find /mnt/BioAdHoc/Groups/vd-ay/hichip-db-loop-calling/results/hicpro/*Homo_Sapiens*/hic_results/data/*/*.allValidPairs);
#do
...
#for fn in $(find /mnt/BioAdHoc/Groups/vd-ay/hichip-db-loop-calling/results/hicpro/*Mus_Musculus*/hic_results/data/*/*.allValidPairs);
#do
#    # create the path to the new link
#    bn=$(basename $fn)
