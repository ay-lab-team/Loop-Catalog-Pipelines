...
#PBS -N run_fithichip_loopcalling_one_config
#PBS -V
...
# print start message
echo "Started: run_fithichip_loopcalling_one_config"
...
#outdir_L5="/mnt/BioAdHoc/Groups/vd-ay/kfetter/hichip-db-loop-calling/results/loops/fithichip/${sample_name}_one_config/L5/"
#outdir_S5="/mnt/BioAdHoc/Groups/vd-ay/kfetter/hichip-db-loop-calling/results/loops/fithichip/${sample_name}_one_config/S5/"
#outdir_L10="/mnt/BioAdHoc/Groups/vd-ay/kfetter/hichip-db-loop-calling/results/loops/fithichip/${sample_name}_one_config/L10/"
#outdir_S10="/mnt/BioAdHoc/Groups/vd-ay/kfetter/hichip-db-loop-calling/results/loops/fithichip/${sample_name}_one_config/S10/"
#outdir_L25="/mnt/BioAdHoc/Groups/vd-ay/kfetter/hichip-db-loop-calling/results/loops/fithichip/${sample_name}_one_config/L25/"
outdir_S25="/mnt/BioAdHoc/Groups/vd-ay/kfetter/hichip-db-loop-calling/results/loops/fithichip/${sample_name}_S25/S25/"
mkdir -p $outdir_S25 #$outdir_L5 $outdir_S5 $outdir_L10 $outdir_S10 $outdir_L25 
...
configfile_S25="results/loops/fithichip/${sample_name}_S25/configfile_S25"
