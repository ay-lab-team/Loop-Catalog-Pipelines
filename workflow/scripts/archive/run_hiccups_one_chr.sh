...
# print start message
echo "Started: run_hiccups_one_chr"
...
outdir="results/loops/hiccups_hicpro_chr1/$sample_name/"
hic_outdir="results/loops/hiccups_hicpro_chr1/$sample_name/hic_input/"
mkdir -p $hic_outdir
...
inpdir="results/loops/hiccups_hicpro_chr1/$sample_name/hic_input/$sample_name.allValidPairs.hic"
java -Xmx40g -jar $juicertools hiccups --cpu --ignore-sparsity -c chr1 -r 5000,10000,25000 $inpdir $outdir
