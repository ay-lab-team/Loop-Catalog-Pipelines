...
echo "# running htrain"
hicreppy htrain -r 10 -m 100000 -w chr17 ${cool1} ${cool2} > ${outdir}/h_value_chr17_${res}.txt

HVAL=$(<${outdir}/h_value_chr17_${res}.txt)
echo "h-value: ${HVAL}"
echo

# run hicrep
echo "# running hicrep scc"
hicreppy scc -v ${HVAL} -m 100000 -w chr17 ${cool1} ${cool2} > ${outdir}/ssc_chr17_${res}.txt

# print end message
echo
echo "Ended: run_hicrep_chr17"
