...
sample_values=( $(grep "${sample}" "results/samplesheets/post-hicpro/human_hicrep_htrain_050723.txt") )
HVAL=${sample_values[1]}
echo $HVAL
hicreppy scc -v ${HVAL} -m 100000 -w 1,10,17,19 ${cool1} ${cool2} > ${outdir}/ssc_${res}_${b1}_${b2}.txt

# print end message
echo
echo "Ended: run_hicrep"
