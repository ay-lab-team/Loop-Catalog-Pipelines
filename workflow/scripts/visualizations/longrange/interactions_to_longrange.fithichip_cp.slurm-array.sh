...
#SBATCH --output=results/shortcuts/logs/interactions_to_longrange/%x.%a.out
#SBATCH --error=results/shortcuts/logs/interactions_to_longrange/%x.%a.err
...
#sbatch --array=1-1000 --job-name interactions_to_longrange.fithichip_cp.1-1000 workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_cp.slurm-array.sh 
#sbatch --array=1-458 --job-name interactions_to_longrange.fithichip_cp.1001-1458 workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_cp.slurm-array.sh 
...
info=$(sed -n ${SLURM_ARRAY_TASK_ID}p workflow/scripts/visualizations/samplesheets/samplesheet.fithichip_cp.wc.1001-1458.txt)
