...
#PBS -N interactions_to_longrange.fithichip_hp
# -t 1
# -d .
...
# qsub workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_hp.qarray.sh -d . -t 3

# to run ALL samples with qsub use:
# qsub workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_hp.qarray.sh -d . -t 1-2868
...
info=$(sed -n ${PBS_ARRAYID}p workflow/scripts/visualizations/samplesheets/samplesheet.fithichip_hp.wc.txt)
