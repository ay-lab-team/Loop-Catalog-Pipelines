...
# bash workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_cp.qarray.sh 3

# to run the code from Qsub use:
# qsub workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_cp.qarray.sh -d . -t 3

# to run ALL samples with qsub use:
# qsub workflow/scripts/visualizations/longrange/interactions_to_longrange.fithichip_cp.qarray.sh -d . -t 1-1458
...
info=$(sed -n ${PBS_ARRAYID}p workflow/scripts/visualizations/samplesheets/samplesheet.fithichip_cp.wc.txt)
